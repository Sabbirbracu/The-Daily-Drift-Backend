...
const Post = require("../models/Post");
const Comment = require("../models/Comment");
// const auth = require("../middleware/auth"); // ⛔️ Commented out
// const { connectDB, closeDB } = require("../db");

// ✅ GET /api/admin/stats/overview (auth temporarily removed)
...
// ✅ GET /api/admin/stats/user-growth (auth temporarily removed)
...
// ✅ GET /api/admin/stats/role-distribution (auth temporarily removed)
